  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (res?.error) {
        ...
        // Success animation or immediate redirect
        ...
        <AnimatePresence mode="wait">
          {error && (
            <motion.div
              ...
              className="p-4 bg-red-50/50 border border-red-100 rounded-2xl flex items-start gap-3"
            >
              <div className="w-5 h-5 rounded-full bg-red-100 flex items-center justify-center flex-shrink-0 mt-0.5">
                <span className="text-[10px] font-bold text-red-600 underline">!</span>
              </div>
